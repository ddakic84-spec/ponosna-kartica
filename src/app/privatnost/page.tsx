    ...
    <main className="mx-auto w-full max-w-2xl px-4 py-10 sm:py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-6 text-zinc-700">
        <section>
          ...
          <p className="mt-1">
            Руковалац података је Фондација „За породицу"
            {" "}
            <span className="text-zinc-400">
              [допунити: пуни назив, сједиште и матични број]
            </span>
        ...
        <section>
          ...
          <p className="mt-1">
            ...
            2026–2028". Правни основ је спровођење програма Фондације и радња коју
            сте сами покренули подношењем захтјева
            {" "}
            <span className="text-zinc-400">
              [правни основ по Закону о заштити личних података ускладити са
              правним савјетником Фондације]
            </span>
            .
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-1">
            Имате право на приступ својим подацима, исправку, брисање и приговор
            на обраду. Захтјев шаљете на{" "}
            <a
              href="mailto:dragan.dakic@zaporodicu.org"
              className="underline"
            >
