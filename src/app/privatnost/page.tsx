...
export const metadata: Metadata = {
  title: "Обавјештење о приватности — Пријатељи породице",
};
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-4 py-10 sm:py-16">
      ...
      <p className="mt-2 text-sm text-zinc-500">
        ...
        е-картицу у оквиру пројекта „Пријатељи породице“.
      </p>
      ...
      <div className="mt-8 space-y-6 text-sm leading-6 text-zinc-700">
        ...
        <section>
          ...
          <p className="mt-1">
            Подаци се обрађују искључиво ради провјере права на Нестро е-картицу
            за остваривање уговореног попуста приликом куповине горива и слања
            активационог кода путем СМС-а, у оквиру пројекта „Пријатељи породице“.
            Подаци се сакупљају и обрађују у складу са Законом о заштити личних
            података те на основу пристанка корисника Поносне картице 2026–2028
            који је дат у писаној форми приликом подношења захтјева у локалној
            заједници.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-1">
            Поднесени захтјеви чувају се за вријеме трајања пројекта „Пријатељи
            породице“, а најкасније по његовом завршетку се бришу. Техничке
            евиденције о ограничењу броја покушаја (у виду хеша IP адресе, без
            саме адресе) бришу се у року од 24 сата.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-1">
            ...
            Nestro petrol (издавање е-картице и слање активационог кода СМС-ом).
